// apps/web/app/api/sensitivity/analyze/route.ts
// BFF proxy: forwards POST /api/sensitivity/analyze to the Python API.
...
export async function POST(request: NextRequest) {
  ...
  try {
    const res = await fetch(`${base}/api/sensitivity/analyze`, {
      method: "POST",
      headers: {
