// apps/web/app/api/forecast/profiles/[line_id]/route.ts
// BFF proxy: forwards GET /api/forecast/profiles/{line_id} to the Python API.
...
export async function GET(
  ...
  try {
    const res = await fetch(`${base}/api/forecast/profiles/${lineId}`, {
      cache: "no-store",
    });
