// apps/web/app/api/forecast/compare/route.ts
// BFF proxy: forwards POST /api/forecast/compare to the Python API.
...
export async function POST(request: NextRequest) {
  ...
  try {
    const res = await fetch(`${base}/api/forecast/compare`, {
      method: "POST",
      headers: {
