// apps/web/app/api/dashboard/shared/route.ts
// BFF proxy: forwards GET /api/dashboard/shared to the Python API.
...
export async function GET(request: NextRequest) {
  ...
  try {
    const res = await fetch(`${base}/api/dashboard/shared`, {
      method: "GET",
